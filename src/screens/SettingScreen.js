        ...
        <View style={styles.container}>
            <View style={styles.sectionContainer}>
                ...
                <View style={styles.sectionBox}>
                    ...
                    <TouchableOpacity style={styles.configButton} onPress={(() => navigation.navigate("Alarm"))}>
                        <Text style={styles.buttonText}>알림</Text>
                        <Icon name="chevron-forward" size={20} color="#000" style={styles.icon} />
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.configButton} onPress={() => navigation.navigate("TTS")}>
